...
- [Python Syntax compared to other programming languages](#python-syntax-compared-to-other-programming-languages)
...
- Python relies on indentation, using whitespace, to define scope; such as the scope of loops, functions and class